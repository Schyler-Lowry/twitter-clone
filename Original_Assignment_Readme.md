The following is a copy of the original README file created by my instructor. It details the requirements of the project, and provides some example screenshots of his version of the project.
